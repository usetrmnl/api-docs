...
In the following guides you'll learn how to access Community plugins, supported [Device Models](https://usetrmnl.com/api/models), [Color Palettes](https://usetrmnl.com/api/palettes), and more.
